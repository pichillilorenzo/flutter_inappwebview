...
abstract class PlatformInAppWebViewController extends PlatformInterface
  ...
  ///
  ///This method should be called when the page is loaded, for example, when the [WebView.onLoadStop] is fired, otherwise the [PlatformWebMessageChannel] won't work.
  ///
