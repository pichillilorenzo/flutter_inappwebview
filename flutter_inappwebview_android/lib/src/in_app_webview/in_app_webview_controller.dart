  ...
  Future<dynamic> _handleMethod(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case "onShowFileChooser":
        debugPrint('onShowFileChooserAndroid-flutter-load...$webviewParams');
        try {
          debugPrint('onShowFileChooserAndroid-flutter-load...${webviewParams
              !.onShowFileChooserAndroid}');
        } catch (error, stack) {
          debugPrint('onShowFileChooserAndroid-flutter-load-$error');
        }

        if ((webviewParams != null &&
            (webviewParams!.onShowFileChooserAndroid != null)) ||
            _inAppBrowserEventHandler != null) {
          String type = call.arguments["type"];
          debugPrint('onShowFileChooserAndroid-flutter-type=$type');
          if (webviewParams != null) {
            if (webviewParams!.onShowFileChooserAndroid != null)
              return await webviewParams!.onShowFileChooserAndroid!(
                  _controllerFromPlatform, type);
          } else {
            return await _inAppBrowserEventHandler!
                .onShowFileChooserAndroid(type);
          }
        }
        break;
      default:
...
"""))?.cast<Map<dynamic, dynamic>>() ?? [];
  ...
  @override
  Future<void> loadData({required String data,
  ...
  @override
  Future<void> zoomBy({required double zoomFactor,
...
(function() {
  ...
  Future<void> addWebMessageListener(
    ...
    "jsObjectName ${webMessageListener.params
