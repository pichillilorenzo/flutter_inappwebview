...
class InAppWebViewSettings {
  ...
  static InAppWebViewSettings? fromMap(Map<String, dynamic>? map,
    ...
    final instance = InAppWebViewSettings(
      ...
      webAuthenticationSupport: switch (enumMethod ?? EnumMethod.nativeValue) {
        ...
        EnumMethod.value =>
          WebAuthenticationSupport.fromValue(map['webAuthenticationSupport']),
        EnumMethod.name =>
          WebAuthenticationSupport.byName(map['webAuthenticationSupport'])
      },
  ...
  Map<String, dynamic> toMap({EnumMethod? enumMethod}) {
    return {
      ...
      "webAuthenticationSupport": switch (
          enumMethod ?? EnumMethod.nativeValue) {
