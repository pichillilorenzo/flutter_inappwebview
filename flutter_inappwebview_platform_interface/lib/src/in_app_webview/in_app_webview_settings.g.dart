...
class InAppWebViewSettings {
  ...
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Windows WebView2 1.0.1901.177+ ([Official API - ICoreWebView2Profile.PreferredColorScheme](https://learn.microsoft.com/en-us/microsoft-edge/webview2/reference/win32/icorewebview2profile?view=webview2-1.0.2849.39#get_preferredcolorscheme))
  ...
  static InAppWebViewSettings? fromMap(Map<String, dynamic>? map,
    ...
    final instance = InAppWebViewSettings(
      ...
      preferredColorScheme: switch (enumMethod ?? EnumMethod.nativeValue) {
        EnumMethod.nativeValue =>
          PreferredColorScheme.fromNativeValue(map['preferredColorScheme']),
        EnumMethod.value =>
          PreferredColorScheme.fromValue(map['preferredColorScheme']),
        EnumMethod.name =>
          PreferredColorScheme.byName(map['preferredColorScheme'])
      },
