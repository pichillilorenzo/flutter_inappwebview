...
bool InAppWebViewWpe::IsWpeWebKitAvailable() {
  ...
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe: WPE WebKit %s", 
...
InAppWebViewWpe::InAppWebViewWpe(FlBinaryMessenger* messenger, int64_t id,
                                 const InAppWebViewWpeCreationParams& params)
    : id_(id),
      settings_(params.initialSettings) {
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: ctor", static_cast<long>(id_));
  }
  ...
  if (params.initialUrlRequest.has_value()) {
    ...
    if (DebugLogEnabled()) {
      g_message("InAppWebViewWpe[%ld]: initialUrlRequest url=%s",
...
void InAppWebViewWpe::AttachChannel(FlBinaryMessenger* messenger,
                                    int64_t channel_id) {
  channel_id_ = channel_id;
  if (messenger == nullptr) {
    g_warning("InAppWebViewWpe[%ld]: AttachChannel messenger is null", 
              static_cast<long>(id_));
    return;
  }
  ...
  channel_delegate_ = std::make_unique<WebViewChannelDelegateWpe>(
      this, messenger, channelName);
  
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: attached channel id=%ld", 
              static_cast<long>(id_), static_cast<long>(channel_id_));
  }
}

InAppWebViewWpe::~InAppWebViewWpe() {
...
void InAppWebViewWpe::InitWpeBackend() {
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: InitWpeBackend %dx%d (scale=%0.2f)",
  ...
  if (gdk_display != nullptr) {
    ...
    if (GDK_IS_WAYLAND_DISPLAY(gdk_display)) {
      ...
      if (wl_display != nullptr) {
        ...
        if (DebugLogEnabled()) {
          g_message("InAppWebViewWpe[%ld]: Using Wayland EGL display", static_cast<long>(id_));
        }
      }
    }
#endif
    ...
    if (egl_display == EGL_NO_DISPLAY && GDK_IS_X11_DISPLAY(gdk_display)) {
      ...
      if (x11_display != nullptr) {
        ...
        if (DebugLogEnabled()) {
          g_message("InAppWebViewWpe[%ld]: Using X11 EGL display", static_cast<long>(id_));
        }
      }
    }
#endif
  ...
  if (egl_display == EGL_NO_DISPLAY) {
    ...
    if (DebugLogEnabled()) {
      g_message("InAppWebViewWpe[%ld]: Using default EGL display", static_cast<long>(id_));
    }
  }
  ...
  if (egl_display != EGL_NO_DISPLAY) {
    ...
    if (!eglInitialize(egl_display, &major, &minor)) {
      g_warning("InAppWebViewWpe[%ld]: Failed to initialize EGL: 0x%x", 
                static_cast<long>(id_), eglGetError());
      egl_display = EGL_NO_DISPLAY;
    } else if (DebugLogEnabled()) {
      g_message("InAppWebViewWpe[%ld]: EGL initialized: %d.%d", 
  ...
  if (!wpe_fdo_initialize_for_egl_display(egl_display)) {
    g_warning("InAppWebViewWpe[%ld]: Failed to initialize WPE FDO (display=%p)", 
              static_cast<long>(id_), (void*)egl_display);
    // Try again with headless mode
    if (!wpe_fdo_initialize_for_egl_display(EGL_NO_DISPLAY)) {
      g_warning("InAppWebViewWpe[%ld]: Failed to initialize WPE FDO in headless mode", 
                static_cast<long>(id_));
      return;
    }
    if (DebugLogEnabled()) {
      g_message("InAppWebViewWpe[%ld]: Using WPE FDO in headless mode", static_cast<long>(id_));
    }
  }
  ...
  if (exportable_ == nullptr) {
    g_warning("InAppWebViewWpe[%ld]: Failed to create WPE exportable backend",
              static_cast<long>(id_));
    return;
  }
  ...
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: WPE backend created successfully",
              static_cast<long>(id_));
  }
}

void InAppWebViewWpe::InitWebView(const InAppWebViewWpeCreationParams& params) {
  if (backend_ == nullptr) {
    g_warning("InAppWebViewWpe[%ld]: Cannot create webview without backend",
              static_cast<long>(id_));
    return;
  }
  ...
  if (webview_ == nullptr) {
    g_warning("InAppWebViewWpe[%ld]: Failed to create WebKitWebView",
              static_cast<long>(id_));
    return;
  }
  ...
  user_content_controller_ = std::make_unique<UserContentControllerWpe>(webview_);

  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: WebView created with WPE backend",
              static_cast<long>(id_));
  }
}

void InAppWebViewWpe::RegisterEventHandlers() {
  if (webview_ == nullptr) {
    return;
  }
  ...
  webkit_web_view_add_frame_displayed_callback(
      ...
      [](WebKitWebView*, gpointer data) {
        auto* self = static_cast<InAppWebViewWpe*>(data);
  ...
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: Event handlers registered",
              static_cast<long>(id_));
  }
}
...
void InAppWebViewWpe::OnFrameDisplayed(void* data) {
  auto* self = static_cast<InAppWebViewWpe*>(data);
...
void InAppWebViewWpe::OnExportDmaBuf(::wpe_fdo_egl_exported_image* image) {
  if (image == nullptr) {
    if (DebugLogEnabled()) {
      g_message("InAppWebViewWpe[%ld]: OnExportDmaBuf called with null image",
                static_cast<long>(id_));
    }
    return;
  }
  ...
  if (DebugLogEnabled() && frame_count % 60 == 0) {
    g_message("InAppWebViewWpe[%ld]: OnExportDmaBuf frame %d (%ux%u)",
...
void InAppWebViewWpe::ReadPixelsFromEglImage(void* egl_image, 
  ...
  if (status != GL_FRAMEBUFFER_COMPLETE) {
    if (DebugLogEnabled()) {
      g_warning("InAppWebViewWpe[%ld]: FBO incomplete: 0x%x", 
...
void InAppWebViewWpe::loadUrl(const std::string& url) {
  if (webview_ == nullptr) return;
  webkit_web_view_load_uri(webview_, url.c_str());
}

void InAppWebViewWpe::loadUrl(const std::shared_ptr<URLRequest>& urlRequest) {
...
void InAppWebViewWpe::loadData(const std::string& data,
...
void InAppWebViewWpe::loadFile(const std::string& asset_file_path) {
  if (webview_ == nullptr) return;
...
std::optional<std::string> InAppWebViewWpe::getUrl() const {
...
std::optional<std::string> InAppWebViewWpe::getTitle() const {
  if (webview_ == nullptr) return std::nullopt;
...
int64_t InAppWebViewWpe::getProgress() const {
...
void InAppWebViewWpe::evaluateJavascript(
...
void InAppWebViewWpe::injectJavascriptFileFromUrl(const std::string& urlFile) {
  std::string script = 
      "(function() {"
...
void InAppWebViewWpe::injectCSSCode(const std::string& source) {
...
void InAppWebViewWpe::injectCSSFileFromUrl(const std::string& urlFile) {
  std::string script =
      "(function() {"
...
void InAppWebViewWpe::addUserScript(std::shared_ptr<UserScript> userScript) {
  if (user_content_controller_) {
    user_content_controller_->addUserScript(userScript);
  }
}

void InAppWebViewWpe::removeUserScriptAt(size_t index, 
...
void InAppWebViewWpe::removeUserScriptsByGroupName(const std::string& groupName) {
  if (user_content_controller_) {
    user_content_controller_->removeUserScriptsByGroupName(groupName);
  }
}

void InAppWebViewWpe::removeAllUserScripts() {
  if (user_content_controller_) {
...
double InAppWebViewWpe::getZoomScale() const {
  if (webview_ == nullptr) return 1.0;
  return webkit_web_view_get_zoom_level(webview_);
}

void InAppWebViewWpe::setZoomScale(double zoomScale) {
  if (webview_ == nullptr) return;
...
void InAppWebViewWpe::scrollTo(int64_t x, int64_t y, bool animated) {
...
void InAppWebViewWpe::scrollBy(int64_t x, int64_t y, bool animated) {
  std::string script = animated
...
int64_t InAppWebViewWpe::getScrollX() const {
  // This would need to be async in a real implementation
  return 0;
}

int64_t InAppWebViewWpe::getScrollY() const {
  // This would need to be async in a real implementation
  return 0;
}
...
FlValue* InAppWebViewWpe::getSettings() const {
  if (settings_) {
...
void InAppWebViewWpe::setSettings(
    const std::shared_ptr<InAppWebViewSettingsWpe> newSettings,
...
void InAppWebViewWpe::setSize(int width, int height) {
  ...
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: setSize %dx%d",
              static_cast<long>(id_), width_, height_);
  }
}

void InAppWebViewWpe::setScaleFactor(double scale_factor) {
...
void InAppWebViewWpe::SetCursorPos(double x, double y) {
...
void InAppWebViewWpe::SetPointerButton(int kind, int button, int clickCount) {
  ...
  switch (static_cast<WpePointerEventKind>(kind)) {
    case WpePointerEventKind::Down:
      ...
      if (DebugLogEnabled()) {
        g_message("InAppWebViewWpe[%ld]: button DOWN at (%d,%d) button=%d state=%d",
    ...
    case WpePointerEventKind::Up:
      ...
      if (DebugLogEnabled()) {
        g_message("InAppWebViewWpe[%ld]: button UP at (%d,%d) button=%d state=%d",
                  static_cast<long>(id_), scaled_x, scaled_y, wpe_button, event.state);
      }
      break;
    default:
...
void InAppWebViewWpe::SetScrollDelta(double dx, double dy) {
  if (wpe_backend_ == nullptr) return;
...
void InAppWebViewWpe::SendKeyEvent(int type, int64_t keyCode, int scanCode, 
  ...
  if (DebugLogEnabled()) {
    g_message("InAppWebViewWpe[%ld]: key %s keyCode=0x%x scanCode=%d mods=0x%x char='%s'",
              static_cast<long>(id_),
...
size_t InAppWebViewWpe::GetPixelBufferSize(uint32_t* out_width, 
...
bool InAppWebViewWpe::CopyPixelBufferTo(uint8_t* dst, size_t dst_size,
                                         uint32_t* out_width,
                                         uint32_t* out_height) const {
  std::lock_guard<std::mutex> lock(buffer_swap_mutex_);
...
bool InAppWebViewWpe::HasDmaBufExport() const {
  return exported_image_ != nullptr;
}

bool InAppWebViewWpe::GetDmaBufFd(int* fd, uint32_t* stride, 
...
void InAppWebViewWpe::SetOnFrameAvailable(std::function<void()> callback) {
  on_frame_available_ = std::move(callback);
}

void InAppWebViewWpe::SetOnCursorChanged(
    std::function<void(const std::string&)> callback) {
  on_cursor_changed_ = std::move(callback);
}

void InAppWebViewWpe::OnShouldOverrideUrlLoadingDecision(int64_t decision_id, 
                                                          bool allow) {
...
void InAppWebViewWpe::OnLoadChanged(WebKitWebView* web_view,
...
gboolean InAppWebViewWpe::OnDecidePolicy(WebKitWebView* web_view,
...
void InAppWebViewWpe::OnNotifyEstimatedLoadProgress(GObject* object,
                                                     GParamSpec* pspec,
                                                     gpointer user_data) {
  auto* self = static_cast<InAppWebViewWpe*>(user_data);
  if (self->channel_delegate_ == nullptr) return;
...
void InAppWebViewWpe::OnNotifyTitle(GObject* object,
                                     GParamSpec* pspec,
                                     gpointer user_data) {
  auto* self = static_cast<InAppWebViewWpe*>(user_data);
  if (self->channel_delegate_ == nullptr) return;
...
gboolean InAppWebViewWpe::OnLoadFailed(WebKitWebView* web_view,
                                        WebKitLoadEvent load_event,
                                        gchar* failing_uri,
                                        GError* error,
                                        gpointer user_data) {
  ...
  self->channel_delegate_->onLoadError(
      std::string(failing_uri ? failing_uri : ""),
      error ? error->code : -1,
...
gboolean InAppWebViewWpe::OnLoadFailedWithTlsErrors(WebKitWebView* web_view,
                                                     gchar* failing_uri,
...
void InAppWebViewWpe::OnCloseRequest(WebKitWebView* web_view, gpointer user_data) {
  auto* self = static_cast<InAppWebViewWpe*>(user_data);
  if (self->channel_delegate_) {
...
gboolean InAppWebViewWpe::OnEnterFullscreen(WebKitWebView* web_view, 
                                             gpointer user_data) {
  auto* self = static_cast<InAppWebViewWpe*>(user_data);
  if (self->channel_delegate_) {
...
gboolean InAppWebViewWpe::OnLeaveFullscreen(WebKitWebView* web_view, 
                                             gpointer user_data) {
  auto* self = static_cast<InAppWebViewWpe*>(user_data);
  if (self->channel_delegate_) {
...
void InAppWebViewWpe::OnMouseTargetChanged(WebKitWebView* web_view,
                                            WebKitHitTestResult* hit_test_result,
                                            guint modifiers,
                                            gpointer user_data) {
  auto* self = static_cast<InAppWebViewWpe*>(user_data);
  ...
  if (cursor_name != self->last_cursor_name_) {
    ...
    if (DebugLogEnabled()) {
      g_message("InAppWebViewWpe[%ld]: cursor changed to '%s'",
...
void InAppWebViewWpe::injectCursorDetectionScript() {
...
void InAppWebViewWpe::updateCursorFromCssStyle(const std::string& cursor_style) {
...
void InAppWebViewWpe::OnExportShmBuffer(struct wpe_fdo_shm_exported_buffer* buffer) {
  if (buffer == nullptr) {
    if (DebugLogEnabled()) {
      g_message("InAppWebViewWpe[%ld]: OnExportShmBuffer called with null buffer",
                static_cast<long>(id_));
    }
    return;
  }
  ...
  if (shm_buffer == nullptr) {
    if (DebugLogEnabled()) {
      g_warning("InAppWebViewWpe[%ld]: Failed to get wl_shm_buffer", static_cast<long>(id_));
    }
    // Release the buffer
    if (exportable_ != nullptr) {
  ...
  if (DebugLogEnabled()) {
    ...
    if (shm_frame_count <= 5 || shm_frame_count % 60 == 0) {
      g_message("InAppWebViewWpe[%ld]: OnExportShmBuffer frame %d (%dx%d stride=%d format=0x%x)",
...
static void wpe_export_fdo_egl_image_callback(
    void* data, 
    struct wpe_fdo_egl_exported_image* image) {
  auto* self = static_cast<flutter_inappwebview_plugin::InAppWebViewWpe*>(data);
