...
import com.pichillilorenzo.flutter_inappwebview_android_geckoview.ISettings;
...
public class InAppBrowserSettings implements ISettings<InAppBrowserActivity> {
  ...
  public Map<String, Object> getRealSettings(@NonNull InAppBrowserActivity inAppBrowserActivity) {
    ...
    realSettings.put("hideUrlBar", inAppBrowserActivity.menu == null || !inAppBrowserActivity.menu.findItem(R.id.flutter_inappwebview_android_geckoview_menu_search).isVisible());
