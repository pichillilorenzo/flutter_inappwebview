...
class ProcessFailedReason_ {
  ...
  @EnumSupportedPlatforms(platforms: [
    EnumWindowsPlatform(
        ...
        apiUrl: 'https://learn.microsoft.com/en-us/microsoft-edge/webview2/reference/win32/webview2-idl?view=webview2-1.0.2849.39#corewebview2_process_failed_reason',
        value: 0
    ),
  ])
  ...
  static const UNRESPONSIVE = const ProcessFailedReason_._internal('UNRESPONSIVE');
  ...
  static const OUT_OF_MEMORY = const ProcessFailedReason_._internal('OUT_OF_MEMORY');
}