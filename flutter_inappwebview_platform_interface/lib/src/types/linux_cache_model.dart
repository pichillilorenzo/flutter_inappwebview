...
part 'linux_cache_model.g.dart';

///Cache model for WebKitWebContext on Linux.
///
///Determines how caching is handled for web content.
@ExchangeableEnum()
class LinuxCacheModel_ {
  // ignore: unused_field
  final int _value;
  const LinuxCacheModel_._internal(this._value);
  ...
  static const DOCUMENT_VIEWER = LinuxCacheModel_._internal(0);
  ...
  static const WEB_BROWSER = LinuxCacheModel_._internal(1);
  ...
  static const DOCUMENT_BROWSER = LinuxCacheModel_._internal(2);
}
