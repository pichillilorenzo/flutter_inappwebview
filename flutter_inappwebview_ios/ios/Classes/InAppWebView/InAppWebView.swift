...
//        }
    ...
    public func prepareAndAddUserScripts() -> Void {
        ...
        configuration.userContentController.addPluginScript(LastTouchedAnchorOrImageJS.LAST_TOUCHED_ANCHOR_OR_IMAGE_JS_PLUGIN_SCRIPT(allowedOriginRules: allowedOriginRules))
